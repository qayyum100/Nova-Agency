        ...
        {submitted ? (
          ...
          <form onSubmit={handleSubmit} noValidate className="space-y-7">
            <div>
              ...
              <input id="name" value={values.name} onChange={(event) => update("name", event.target.value)} className="form-field w-full border-b border-white/20 bg-transparent px-0 py-3 text-white outline-none placeholder:text-white/25" placeholder="Your name" aria-invalid={Boolean(errors.name)} />
            ...
            <div>
              ...
              <input id="email" type="email" value={values.email} onChange={(event) => update("email", event.target.value)} className="form-field w-full border-b border-white/20 bg-transparent px-0 py-3 text-white outline-none placeholder:text-white/25" placeholder="you@company.com" aria-invalid={Boolean(errors.email)} />
            ...
            <div>
              ...
              <textarea id="message" rows={5} value={values.message} onChange={(event) => update("message", event.target.value)} className="form-field w-full resize-none border-b border-white/20 bg-transparent px-0 py-3 text-white outline-none placeholder:text-white/25" placeholder="Tell us about the project..." aria-invalid={Boolean(errors.message)} />
